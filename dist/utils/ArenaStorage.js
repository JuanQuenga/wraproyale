...
class ArenaStorage {
    constructor() {
        this.arenasMap = new Map(); // Map<SCID, Arena>
        this.filePath = path.join(__dirname, '../../json/arenas.json');
        this.load();
    }
    /**
    ...
    read() {
        try {
            ...
            const arenaJsonData = JSON.parse(rawJsonData);
            for (const arena of arenaJsonData) {
                this.arenasMap.set(arena.id, arena);
            }
        }
        catch (e) {
...
exports.ArenaStorage = ArenaStorage;
